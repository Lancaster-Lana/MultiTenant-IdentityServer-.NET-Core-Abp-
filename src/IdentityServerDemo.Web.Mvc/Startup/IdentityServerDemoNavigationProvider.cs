...
namespace IS.Web.Startup
{
    ...
    /// </summary>
    public class ISNavigationProvider : NavigationProvider
    {
            ...
            context.Manager.MainMenu
                ...
                //    )
                    ...
                    new MenuItemDefinition(
                        ...
                        url: "Clients",
                        icon: "people",
                        requiredPermissionName: PermissionNames.Pages_Clients
                    )
                ).AddItem(
                    new MenuItemDefinition(
                        PageNames.Candidates,
                        L("Candidates"),
                        url: "Candidates",
                        icon: "people",
                        requiredPermissionName: PermissionNames.Pages_Candidates
                    )
                ).AddItem(
                     new MenuItemDefinition(
                         PageNames.Contracts,
                         ...
                         url: "Contracts",
                         //icon: "contracts",
                         requiredPermissionName: PermissionNames.Pages_Contracts
                     )
                ).AddItem(
                     new MenuItemDefinition(
                         PageNames.Documents,
